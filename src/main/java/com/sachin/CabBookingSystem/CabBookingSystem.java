package com.sachin.CabBookingSystem;

import com.sachin.controller.*;
import com.sachin.model.*;
import com.sachin.utility.*;
...
public class CabBookingSystem {
    public static void main(String[] args) {
        ...
        System.out.println("\n Registering Drivers...");
       // driverCdriverController.addDriver();
        ...
        List<Driver> drivers = Arrays.asList(
                ...
                new Driver("1", "Charlie Brown", "charlie@example.com", "4445556666", "SUV")
        );
